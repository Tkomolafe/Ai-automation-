...
| Name of the brand                                      | Target company name   | Clothing Line by Timi                            |
| Email of the brand                                     | Contact email         | hello@clothbytimi.com                            |
| What is the Brand's Product or Service?                | Brief description     | Luxury Clothes                                   |
| Have you used the product or the service of the brand? | Yes/No                | Yes                                              |
| If yes, what did you like about the product/service?   | Your experience       | Amazing Quality                                  |
...
- Change `sendTo` from `tomiwaemmanuel49@gmail.com` to **your email**
...
| ----------------- | ------------------ | ----------------- | ----- | --------------- | ------------------ | ------------------- |
| Test Brand Co     | test@youremail.com | Clothes           | Yes   | Amazing results | Great engagement   | 70% female audience |
